...
def covert_to_forward():
    fastq_input = "data/Sample_MRG/MRG_CTTGTA_mergred.fastq"
    with open(fastq_input, "rU") as handle, open("data/MRG_CTTGTA_forward_strand.fastq", "w") as output_handle:
